                            ...
                            <?php
                                if(!$_SESSION['nombreUser']=="" &&!$_SESSION['claveUser']==""){
                                    echo '
                                        ...
                                        <br>
                                        <img class="img-responsive center-all-contens" src="imagenes/img/img-registration.png">
                                    ...
                                    echo '
                                        ...
                                        <p>
                                            ...
                                            y contraseña con la cual te registraste en <span class="tittles-pages-logo">A MI MADERA</span>.
                                        </p>
                                        <br>
