    ...
    if(!$nombre==""&&!$clave==""){
        ...
        if($radio=="option2"){
            ...
            if($AdminC>0){
              ...
              echo '<img src="imagenes/img/error.png" class="center-all-contens"><br>Error nombre o contraseña invalido'; 
            }
        }
        if($radio=="option1"){
        ...
        echo '<img src="imagenes/img/error.png" class="center-all-contens"><br>Error campo vacío<br>Intente nuevamente';
    }