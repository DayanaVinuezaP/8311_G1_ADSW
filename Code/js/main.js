$(document).ready(function() {
    ...
    /*Funcion para enviar datos obtenidos  de los formularios con ajax*/
    $('.FormCatElec').submit(function(e){
        ...
        if(formType=="login"){
            $.ajax({
                ...
                data: data,
                beforeSend: function(){
                    $(".ResFormL").html('Iniciando sesión<br><img src="imagenes/img/loading.gif" class="center-all-contens">');
                },
                error: function() {
            ...
            $.ajax({
                ...
                data: data,
                beforeSend: function(){
                    $(".ResForm").html('Procesando... <br><img src="imagenes/img/enviando.gif" class="center-all-contens">');
                },
                error: function() {
